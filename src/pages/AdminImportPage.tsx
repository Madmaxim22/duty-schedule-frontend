...
export function AdminImportPage() {
  ...
  const importHint = useMemo(
    () =>
      'За выбранный период для сотрудников из файла отсутствия будут полностью заменены. Дежурства из файла перезапишут только указанные дату и кабинет; остальные назначения не изменятся.',
    [],
  );
